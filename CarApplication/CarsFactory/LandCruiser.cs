...
{
    public class LandCruiser : CarBase
    {
        public LandCruiser(int basePrice, CarModel carModel, TransmissionType transmission, VolumeType volume) : base(basePrice, carModel, transmission, volume)
        {
