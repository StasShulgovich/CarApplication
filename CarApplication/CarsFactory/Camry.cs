...
{
    public class Camry : CarBase
    {
        public Camry(int basePrice, CarModel carModel, TransmissionType transmission, VolumeType volume) : base(basePrice, carModel, transmission, volume)
        {
